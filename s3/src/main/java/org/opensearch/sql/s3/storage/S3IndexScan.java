...
import org.opensearch.sql.s3.request.S3QueryRequest;
...
public class S3IndexScan extends TableScanOperator {

  private final S3ClientImpl prometheusService;
  ...
  @Getter
  @ToString.Include
  private final S3QueryRequest request;
   ...
   * Constructor.
   */
  public S3IndexScan(PrometheusClient prometheusService, PrometheusConfig prometheusConfig,
                     String metricName,
